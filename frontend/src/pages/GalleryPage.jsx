                ...
                <div className="profile-card mx-auto">
                  ...
                  <div className="relative z-10 space-y-4">
                    ...
                    <div className="flex justify-center">
                      <div className="w-24 h-24 rounded-full overflow-hidden border-4 border-cyan-500 shadow-lg shadow-cyan-500/50">
                        <img
                          src={
                            profile.photo_url ||
                    ...
                    <div className="text-center space-y-3">
                      ...
                      {/* Encrypted ID */}
                      <div className="py-2 px-3 bg-black/40 rounded-lg border border-cyan-500/30">
                      ...
                      {/* Bio */}
                      {profile.bio && (
                        <div className="text-left py-2 px-3 bg-black/20 rounded-lg border border-cyan-500/10">
